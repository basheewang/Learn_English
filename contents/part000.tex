...
\begin{landscape}
  ...
  \begin{adjustwidth}{-2.2cm}{0cm}
    \begin{longtblr}[
      ...
      column{3}={0.42\linewidth, halign=l},
      rows={abovesep=5pt},
      ...
      \textbf{宾语补足语} (Object Complement) & 它跟在宾语后面，用来补充说明宾语的身份、特征、状态或发生的动作。逻辑模型： $主语 + 动词 + 宾语 (A) + 宾补 (A')$，（逻辑上，宾语和宾补之间存在一种隐形的 “is” 关系，即 $A = A'$）& {宾语补足语的四种常见“形态”:
                                                                                                                                                                                                                                 \begin{enumerate}[nosep]
                                                                                                                                                                                                                                   \item 名词/形容词作宾补 (描述身份或状态)，如：They named the dog \textit{Buddy}.
                                                                                                                                                                                                                                   \item 动词不定式 (to do) 作宾补 (要求或建议)，如：The doctor told him \textit{to exercise more}.
                                                                                                                                                                                                                                   \item 现在分词 (doing) 作宾补 (强调动作正在进行)，如：I saw the tester \textit{running the diagnostic program}.
                                                                                                                                                                                                                                   \item 过去分词 (done) 作宾补 (强调被动或完成状态)，如：I need to get the report \textit{finished} by Friday.
                                                                                                                                                                                                                                 \end{enumerate}
                                                                                                                                                                                                                                 }\\
      ...
      \textbf{限制性定语从句} (Restrictive Relative Clause)&它是主句不可分割的一部分。它存在的目的是为了限定（Limit）先行词的范围。没有它，我们不知道主句在说“哪一个”。特点： 没有逗号隔离。&The engineers [who work at Intel] are developing a new chip.\\
      \textbf{非限制性定语从句} (Non-restrictive Relative Clause)&它只是对先行词的补充说明（Extra Information）。先行词本身已经很明确了（通常是人名、地名或世界上独一无二的事物），从句只是顺便提一下它的属性。特点： 必须用逗号隔开。&Tom, who works at this company, is an expert in this business.\\
    \end{longtblr}
  \end{adjustwidth}
\end{landscape}
...
% LocalWords:  vlines hlines halign valign xetex abovesep nosep LocalWords bg
% LocalWords:  bg vbox
